...
_CONTENT_TYPES_BY_SCOPE = {
    # "signals": OpenWebUI/Hermes bridge stores append-only raw user signals
    # (e.g. feedback) under viking://user/{uid}/signals/{signal_type}/...
    # These MUST NOT be routed into memory vectorization; classifying them as
    # their own "signal" context type makes that policy enforced uniformly by
    # every caller of context_type_for_uri.
    "user": {"memories": "memory", "signals": "signal"},
